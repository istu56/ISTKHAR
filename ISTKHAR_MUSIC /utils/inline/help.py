...
def help_pannel(_, START: Union[bool, int] = None):
    ...
    upl = InlineKeyboardMarkup(
	    ...
	    [
	        InlineKeyboardButton(
                    text=_["H_B_34"],
                    callback_data="rajputRishu9bottonnn",
		)
	    ],    
            [
                InlineKeyboardButton(
...
def oyeISTKHAR_markup(_):
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("ᴏᴡɴᴇʀ",   user_id=config.OWNER_ID)],
        [
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/ISTKHARXDuniya"),
            InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url="https://t.me/About_ISTKHARa")
        ],
