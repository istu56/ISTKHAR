...
async def gen_thumb(videoid: str):
    ...
    try:
        ...
        font_path = "IstkharMusic/assets/font3.ttf"

        # Overlay and bounding box detection
        player = Image.open("IstkharMusic/assets/nand.png").convert("RGBA").resize((1280, 720))
        ...
        info_font = ImageFont.truetype("IstkharMusic/assets/font2.ttf", 22)
        draw.text((text_x, info_y), info_text, (200, 200, 200), font=info_font)

        time_font = ImageFont.truetype("IstkharMusic/assets/font2.ttf", 26)
        ...
        # Watermark
        watermark_font = ImageFont.truetype("IstkharMusic/assets/font2.ttf", 24)
