...
from ISTKHAR_MUSIC.utils.formatters import convert_bytes
from ISTKHAR_MUSIC.utils.inline.song import song_markup

mycookies = "ISTKHAR_MUSIC/cookies.txt"
...
async def song_download_cb(client, CallbackQuery, _):
    ...
    with yt_dlp.YoutubeDL({"cookiefile": "ISTKHAR_MUSIC/cookies.txt", "quiet": True}) as ytdl:
